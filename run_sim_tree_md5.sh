...
BURN=2000
ITER=8000
MDSCEN=5 #missing data scenario 1=no missing data, 2=uniform [0,1] missing data, 3=10% missing data, 4=20% missing data, 5=30% missing data, 6=scrnaseq scenario
